...
void loop() 
{
	...
	if(Serial.available())
	{
		...
		if(startBit == true&num1==2){
			switch(val)             //switch statement
			{
				case '1': front=250;break;       //if val equals to F，front=250，balance robot goes front.
				case '2': back=-250; break;       //go back
				case '3': left=1; break;    //turn left
				case '4': right=1;break;                         // turn right
				case '0': front=0;back=0;left=0;right=0;break;    //stop
			}
			num1=0;
			startBit= false;
		}
